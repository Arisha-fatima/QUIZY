...
public class Rules3 extends JFrame implements ActionListener{
    JButton b1, b2;
    String username;
    Rules3(String username){
        this.username = username;
        setBounds(70, 200, 1150, 600);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
       
        JLabel l1 = new JLabel("Welcome " + username + " to Quizy Fire");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            this.setVisible(false);
            new PatternLogic(username).setVisible(true);
        }
    }
